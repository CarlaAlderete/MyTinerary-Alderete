const info = [
    { foto:'remo.jpg',h3: 'Why us?', text:'A short-term rental service by and for gay travelers is needed to help provide a comfortable and safe experience.', id: 'par'},
      ...
      { foto:'party.jpg', h3: 'Dates and activities', text:'We have updated all the activities of the LGBTQ + community in each city and the LGBTQ + pride marches so you can live a different experience', id: 'par'},
];
